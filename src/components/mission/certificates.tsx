            ...
            <div className="grid grid-cols-2 gap-5">
                {data.map((item, i) => (
                    <button
                        key={item.id}
                        type="button"
                        className="relative h-[398px] outline-none focus-visible:ring-2 focus-visible:ring-aqua-base"
                        onClick={() => {
                            setIndex(i);
                            setOpen(true);
                        }}
                    ...
                    >
                        <Image
                            ...
                            alt={item.alternateText || "Сертификат"}
                            fill
                            className="object-contain rounded-md shadow-[4px_4px_39px_0px_#0000001A]"
