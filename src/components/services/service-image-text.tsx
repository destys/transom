    ...
    <div className="relative mb-14 lg:mb-28 py-16 xl:py-0">
      ...
      <div className="container grid xl:grid-cols-12 gap-5 items-center xl:min-h-[650px] relative z-20">
        <Image
          ...
          width={739}
          height={739}
          className="w-full h-[110%] absolute -left-[35%] 2xl:-left-[40%] bottom-0 object-contain max-xl:hidden"
        />
        <div className="relative h-full col-span-5 max-xl:hidden overflow-visible"></div>
