            ...
            <div className="container relative">
                ...
                <div className="flex gap-5 items-center w-full mb-[72px] -mt-[63px]">
                    <div className="flex items-center gap-5 mr-auto">
                        <Link href={'tel:'} className="flex gap-2.5 items-center text-aqua-base text-xs font-extrabold transition-colors hover:text-sand-base">
                            <Image src={'/icons/phone.svg'} alt="phone" width={16} height={16} />
                            8 (495) 780-36-55
                        </Link>
                        <Link href={'mailto:'} className="flex gap-2.5 items-center text-aqua-base text-xs font-extrabold transition-colors hover:text-sand-base">
                    ...
                    <div className="ml-auto flex items-center gap-5">
                        <div className="flex gap-3.5">
                            <Link href={'mailto:'} className="flex gap-2.5 items-center text-aqua-base text-xs font-semibold">
