...
const PostPage = async ({ params }: Props) => {
    ...
    return (
        <div className="py-16 lg:py-32 mb-20">
            <div className="container">
                ...
                <div className="mb-8 md:md-12 lg:mb-20 relative h-[240px] md:h-[360px] lg:h-[460px]">
                    <Image src={`${API_URL}${post.image.url}`} alt={post.title} fill className="object-cover" />
                </div>
                <div className="mb-8 text-xl md:text-2xl lg:text-3xl font-semibold text-aqua-base">{post.subtitle}</div>
