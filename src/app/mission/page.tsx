    ...
    <div className="mb-24 lg:mb-48">
      ...
      <div className="mt-12 lg:mt-24">
        <div className="container max-w-[1106px]">
          {page.text_1 && (
            <div className="text-center font-mono text-xl lg:text-3xl text-aqua-base mb-8">
              <BlocksRenderer content={page.text_1} />
            </div>
          )}
          {page.text_2 && (
            <div className="mb-24 text-center">
              <BlocksRenderer content={page.text_2} />
            </div>
          )}
        ...
        <div className="max-lg:mb-56">
          <div className="container flex flex-col lg:grid  lg:grid-cols-12 gap-5">
            <div className="col-span-6">
              {page.certificates && <Certificates data={page.certificates} />}
            </div>
            <div className="max-lg:hidden"></div>
            <div className="col-span-5">
              {page.ratings && <Ratings data={page.ratings} />}
            </div>
          </div>
        </div>
      </div>
