...
const ContactsPage = async () => {
  ...
  return (
    <div className="relative min-h-[820px] max-lg:mb-64 h-[73vh] flex flex-col items-center md:flex-row">
      <iframe
        src="https://yandex.ru/map-widget/v1/?um=constructor%3A55a3bf6619e74df28110d166504a0ed623a1f51ea8f73d47d4b29862a9fc0547&amp;source=constructor"
        width="1280"
        height="720"
          ...
          <div className="mb-9 pb-8 border-b border-[#D9D9D9] flex flex-col gap-5">
            ...
            <div className="flex items-start gap-6">
              <Image
                ...
                className="mt-0.5"
              />
              125424 Россия, г. Москва,
              <br />
              Волоколамское шоссе, д. 73, офис 219 <br />
